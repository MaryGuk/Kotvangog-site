...
const usePreviewPhotoDialogState = () => {
    ...
    const checkIsLastPhoto = () => fullImageSrcData && fullImageSrcData.idx === fullImageSrcData.gallery - 1;
    ...
    return {fullImageSrcData, setFullImageSrcData, isFirstPhoto, isLastPhoto, handlePrevPhoto, handleNextPhoto};
}
