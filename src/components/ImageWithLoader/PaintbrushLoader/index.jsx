...
const PaintbrushLoader = ({ width, backgroundColor }) => {
  ...
  return (
    <LoaderStaticWrapper
      width={staticWrapperSize}
      height={staticWrapperSize}
    ...
    >
      <LoaderRotatingWrapper>
        ...
        >
          ...
          <g
            transform="translate(0.000000,1174.000000) scale(0.100000,-0.100000)"
            fill="black"
            stroke="none"
          >
            <path
              d="M12258 11731 c-20 -4 -66 -22 -102 -40 -68 -33 -193 -158 -947 -941
            ...
            />
            <path
              d="M 0 6800 L 5000 11740 L 12800 11740 L 12800 5000 L 7500 0 Z"
              fill={currentBackgroundColor}
            />
            <path
              d="M 4350 2856 L 12800 11740 L 5170 2113 Z"
              fill="url(#brush-handle-gradient)"
            />
          </g>
        </svg>
      </LoaderRotatingWrapper>
