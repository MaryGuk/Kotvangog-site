        ...
        isMobile ? (
          ...
          <>
            ...
            <OilPortrait
              ...
              imageDesktop={"https://www.dropbox.com/scl/fi/5ms2icxzh7gkbbw1n0kf2/1400_likeness-portrait.png?rlkey=5vvmwjjk1kbos4fjdd3g0dh6g&dl=0&raw=1"}
              advantages={[
                "Бесплатно подберем 7-8 грубых макетов.",
                "Более 600 тематических образов.",
                "Портретное сходство сохраняем на 100%"
              ]}
              descriptionMobile={"Не знаете какой образ подойдет? Мы бесплатно подберем 7-8 грубых макетов под ваше фото. Вы сами выберите образ который вам понравится."}
              descriptionDesktop={[
                {
