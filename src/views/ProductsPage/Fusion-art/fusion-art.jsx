...
const FusionArt = () => {
  return (
    <div className="fusion-art__page">
      <div id="fusion-art" className="fusion-art__container">
        ...
        <div className="fusion-art__information">
          ...
          <div className="fusion-art__description">
            ...
            Фон предоставляем на Ваш выбор. Портрет отлично работает в тандеме с
            услугой «арт-гель», придающей объём картине. Печать на холсте или
            портрет маслом на холсте —«Фюжн» превосходен в любом виде…
          </div>
          <div>
            <a href="#">
      ...
      <div className="fusion-art__gallery">
        <img
          className="fusion-art__image"
          src="/images/styles/Фьюжн/f1.jpg"
          alt=""
        />
        <img
          className="fusion-art__image"
        ...
        <img
          className="fusion-art__image"
          src="/images/styles/Фьюжн/f3.jpg"
          alt=""
        />
        <img
          className="fusion-art__image"
          src="/images/styles/Фьюжн/f4.jpg"
          alt=""
        />
        <img
          className="fusion-art__image"
          src="/images/styles/Фьюжн/f5.jpg"
          alt=""
        />
        <img
          className="fusion-art__horizontal"
          src="/images/styles/Фьюжн/f6.jpg"
          alt=""
        />
      </div>
    </div>
