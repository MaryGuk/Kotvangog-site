import ImageMastihin from "./Image-mastihin";
import "./mastihin-art.css";

const MastihinArt = () => {
  return (
    <div className="mastihin-art__page">
      <div className="mastihin-art__general">
        <div id="mastihin-art" className="mastihin-art__container">
          <div className="mastihin-art__inf">
            ...
            <div className="mastihin-art__description">
              ...
              портрета именно для Вас. Готовьтесь собрать возгласы "WOW", ведь
              это самый-самый арт. Портрет может быть выполнен как в спокойных
              тонах, так и в ярких, ослепительных тонах. Печать на холсте или
              портрет маслом в исполнении художника? Решать Вам - и в одном, и в
              другом исполнении этот вид портрета не оставит никого равнодушным.
            </div>
            <div>
              <a href="">
